...
namespace Todo.Web.Controllers
{
    ...
    public class TodosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Description")] CreateTodoListViewModel todoListViewModel)
        {
            ...
            {
                int userId = int.Parse(User.FindFirst("userId")!.Value!);
                await _todosClient.CreateTodo(new Clients.Models.TodoList.CreateTodoListInputModel
                {
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            // Redirect to the TodoTaskController's Index with the list ID
        ...
        public async Task<IActionResult> Edit(int? id, [Bind("Id, Description, IsActive")] TodoListViewModel todoListModel)
        {
            ...
            if (ModelState.IsValid)
            {
                await _todosClient.UpdateTodo(id, new Clients.Models.TodoList.UpdateTodoListInputModel
                {
