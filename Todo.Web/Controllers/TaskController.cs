...
using Todo.Web.Clients.Models.TodoTask;
    ...
    public class TaskController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Description, DueDate, id")] CreateTodoTaskViewModel taskViewModel, int? id)
        {
            if (ModelState.IsValid)
            {
                ...
                await _taskClient.CreateTask(new Clients.Models.TodoTask.CreateTodoTaskInputModel
                {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int? id, [Bind("Id, Description, IsCompleted, DueDate")] TodoTaskViewModel taskModel)
        {
            if (id != taskModel.Id)
            {
                return NotFound();
            ...
            if (ModelState.IsValid)
            {
                ...
                await _taskClient.UpdateTask(id, new Clients.Models.TodoTask.UpdateTodoTaskInputModel
                {
